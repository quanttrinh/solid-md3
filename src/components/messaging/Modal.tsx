...
function ModalHeader(props: ModalHeaderProps) {
  ...
  return (
    <div
      {...rest}
      class={cn(
        "border-md3-outline-variant flex items-center justify-between gap-4 border-b px-6 py-4",
        local.class,
      )}
    >
...
function ModalBody(props: JSX.HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div
      {...rest}
      class={cn("scrollbar-hide flex-1 overflow-y-auto px-6 py-4", local.class)}
    >
      {local.children}
    </div>
  );
...
function ModalFooter(props: JSX.HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div
      {...rest}
      class={cn(
        "border-md3-outline-variant flex items-center justify-end gap-3 border-t px-6 py-4",
        local.class,
      )}
    >
      {local.children}
